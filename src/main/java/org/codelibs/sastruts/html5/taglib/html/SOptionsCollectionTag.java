...
/**
 * Extended OptionsCollectionTag.
 * 
 * @author shinsuke
 *
 */
public class SOptionsCollectionTag extends OptionsCollectionTag implements
        DynamicAttributes {
    ...
    @Override
    protected void addOption(final StringBuffer sb, final String label,
            final String value, final boolean matched) {
